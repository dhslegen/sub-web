  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [{value: "https://sub.dahaoshen.com/sub?"}],
        remoteConfig: [
          {
            label: "universal",
            options: [
          ...
          },
          {
            ...
            options: [
              ...
              {
                label: "ACL4SSR_Online_AdblockPlus_Dhs",
                value:
                    "https://raw.githubusercontent.com/dhslegen/ACL4SSR/master/Clash/config/ACL4SSR_Online_AdblockPlus.ini"
              },
              {
                label: "Maying",
                value:
